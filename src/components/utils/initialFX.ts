...
export function initialFX() {
  ...
  if (prefersReducedMotion()) {
    // No reveal animations: just make everything visible immediately.
    gsap.set(
      [
        ".landing-info .landing-role",
        ".landing-intro .landing-hello",
        ".landing-intro h1",
        ".landing-h2-info",
        ".landing-info-h2",
        ".header",
  ...
  const landingText = new SplitText(
    [".landing-info .landing-role", ".landing-intro .landing-hello", ".landing-intro h1"],
    {
      type: "chars,lines",
